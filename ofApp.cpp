...
void ofApp::update() {
	...
	for (int i = 0; i < this->location_list.size(); i++) {
		...
		this->setBoxToMesh(this->face, this->line, this->location_list[i], 20, 20, 20);
	}
}
...
void ofApp::setBoxToMesh(ofMesh& face_target, ofMesh& frame_target, glm::vec3 location, float height, float width, float depth) {
	...
	auto noise_value = ofNoise(ofRandom(1000), ofGetFrameNum() * 0.006);
	...
	if (noise_value < 0.45) {
		...
		scale = ofMap(noise_value, 0.45, 0.55, 0, 1);
	}
